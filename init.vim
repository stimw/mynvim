"  ____  _   _                                _
" / ___|| |_(_)_ __ _____      __  _ ____   _(_)_ __ ___
" \___ \| __| | '_ ` _ \ \ /\ / / | '_ \ \ / / | '_ ` _ \
"  ___) | |_| | | | | | \ V  V /  | | | \ V /| | | | | | |
...
let g:coc_global_extensions = ['coc-yank','coc-snippets','coc-lists','coc-highlight','coc-git','coc-floaterm','coc-explorer','coc-tsserver','coc-python','coc-json','coc-html','coc-css']
